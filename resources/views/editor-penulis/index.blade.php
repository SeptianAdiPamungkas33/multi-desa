...
@section('container')
    <div class="p-4 mt-20 ml-64">
        <p class="mb-8 text-xl font-bold uppercase">Manajemen Penulis</p>
        <!-- Start coding here -->
                    ...
                    <tbody>
                        @foreach ($editorpenulis as $item)
                            <tr class="border-b dark:border-gray-700">
                                ...
                                <td class="px-4 py-3">{{ auth()->user()->nama_desa ?? '' }}</td>
                                ...
                                <td class="flex items-center justify-end px-4 py-3">
                                    ...
                                    <div id="toggles{{ $item->id }}"
                                        ...
                                        <ul class="py-1 text-sm text-gray-700 dark:text-gray-200"
                                            ...
                                            <li>
                                                <a href="editor-penulis/{{ $item->id }}/edit"
