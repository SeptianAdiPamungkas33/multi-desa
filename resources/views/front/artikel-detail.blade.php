...
<body class="overflow-x-hidden w-full  antialiased">
    ...
    <div class="flex items-center justify-center w-full overflow-x-hidden pt-0 lg:pt-12 pb-12 xl:pt-12 xl:pb-24">
        <div class="container w-full flex flex-col items-center justify-center mx-8 lg:mx-60 h-full py-12">
            ...
            <div class="flex flex-col items-center py-2 w-full lg:items-start lg:w-full lg:py-6 xl:py-6 lg:text-left">
                <h1 class="relative mb-4 text-2xl font-black leading-tight text-gray-900 sm:text-4xl xl:mb-8">{{ $postingan->judul }}</h1>
